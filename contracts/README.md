...
本目录冻结 br-ai-spec 输出给 br-ai-spec-visual 和 skill-q-platform 的跨仓库协议。

## 输出清单

| 协议 | Schema | Fixture | 消费方 |
| --- | --- | --- | --- |
| RunEvent | `schemas/run-event.schema.json` | `fixtures/run-event.fixture.json` | br-ai-spec-visual |
| EvidenceReport | `schemas/evidence-report.schema.json` | `fixtures/evidence-report.fixture.json` | br-ai-spec-visual |
