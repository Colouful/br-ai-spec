...
flowchart TB
    ...
    subgraph 独立部署
        B[br-ai-spec-visual<br/>Next.js 应用]
        C[(MySQL/MariaDB)]
    end
...
│                            ▼                                 │
│  ┌─────────────────────────────────────────────────────┐     │
│  │ br-ai-spec-visual (Next.js + WebSocket)              │     │
│  │ 端口：3000                                           │     │
│  └────────────────────┬────────────────────────────────┘     │
│                       │                                      │
│                       ▼                                      │
...
# ===== 可选（生产环境务必配置） =====
# 会话密钥（强随机字符串）
BR_AI_SPEC_VISUAL_SESSION_SECRET="your-strong-random-secret-here"
...
services:
  visual:
    ...
    environment:
      ...
      - BR_AI_SPEC_VISUAL_SESSION_SECRET=your-secret-here
...
| 配置项 | 说明 |
|--------|------|
| BR_AI_SPEC_VISUAL_SESSION_SECRET | 强随机字符串（≥32 字符） |
