...
ex-ai-spec 是一套 **AI Coding 团队规范驱动开发 CLI（当前版本面向前端）**，内置 **Vue 3** 与 **React** 两套 Profile，旨在让 Cursor、Claude Code、OpenCode、Trae 等 AI 编码助手在 **前端工程** 中自动遵循统一的开发规范、工作流程和最佳实践。
